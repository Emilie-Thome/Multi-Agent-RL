# Multiple Agents Reinforcement Learning (MARL)

Using rllab to develop reinforcement learning with quantization of the stochastic gradients of multiple agents performing on different environments.
