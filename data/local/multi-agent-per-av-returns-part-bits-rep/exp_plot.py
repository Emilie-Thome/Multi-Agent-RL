...
# dir_prefix = 'multi_agent_per_av_returns_part_bits_rep_2021_04_09_10_16_24_00'
# participation_rates = [0.1, 0.5, 1]
# agents_number = 10
# average_periods = [1, 5, 10]
# repetition = 3

dir_prefix = 'multi_agent_per_av_returns_part_bits_rep_2021_04_09_11_52_48_00'
participation_rates = [0.3, 0.5, 0.6]
agents_number = 10
average_periods = [1, 5]
repetition = 5

files_id = ['0'+str(i) for i in range(1,10)] + [str(i) for i in range(10,31)]
file = '/progress.csv'
